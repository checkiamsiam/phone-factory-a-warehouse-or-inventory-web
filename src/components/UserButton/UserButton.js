    ...
    <div>
      ...
      {openDropdown && <div id="userDropdown" className="z-10 absolute top-14 right-14 bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
        ...
        <ul className="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
          ...
          <li>
            <button onClick={() => navigate('/inventory/my-added')} className="block mx-auto px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Your Added</button>
          </li>
          <li>
            <button onClick={() => navigate('/inventory/add')} className="block mx-auto px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Add New</button>
          </li>
          <li>
