      ...
      <div className="w-full pt-2 p-4">
        ...
        <div className="mx-auto md:p-6 md:w-1/2">
          <div className="flex flex-wrap justify-between">
            ...
            <a href="#home" className="mt-8 text-orange-400 hover:text-orange-600 transition duration-500">
            ...
            <form method="POST" action="#login">
              <div className="mb-8">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input id="username" className="block pr-10 shadow appearance-none border-2 border-orange-100 rounded w-full py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-orange-500 transition duration-500 ease-in-out" placeholder="you@example.com" />
                </div>
              ...
              <hr/>
                <div className="mt-8">
                  <p className="text-sm">
                    no account
                    <a className="font-bold text-sm text-orange-500 hover:text-orange-800" href="#register">
                      sign up
                    </a>
                  </p>
                </div>
