...
const Banner = () => {
  ...
  return (
    ...
    <div  id='top' className="w-[95vw] mx-auto md:p-0 p-5 pt-0">
      <Slider {...settings}>
        <div>
          <img className="w-full md:h-[100vh]" src={sliderimage3} />

          <div data-aos="fade-up" className="lg:absolute lg:top-1/3 lg:ml-5 lg:w-1/4 z-10">
        ...
        <div>
          ...
          <div data-aos="fade-up" className=" lg:absolute lg:top-1/4 lg:right-5 lg:w-1/4 z-10">
