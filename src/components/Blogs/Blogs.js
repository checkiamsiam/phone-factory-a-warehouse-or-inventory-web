  ...
  return (
    <div className='my-5 py-20 md:px-32 px-5'>
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-5 ">
        <div data-aos="fade-up" className=" block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 ">
        ...
        <div data-aos="fade-down" className="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
