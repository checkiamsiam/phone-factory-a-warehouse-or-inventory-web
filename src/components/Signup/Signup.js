            ...
            <div className="md:w-1/2 w-full bg-white rounded shadow-2xl hover:shadow-blue-300 p-8 m-4">
                ...
                <form className='mt-5' action="/" method="post">
                    ...
                    <span className="text-red-500">&nbsp;*</span> First Name:</label>
                        <input className="border py-2 px-3 text-grey-800 outline-blue-400  " type="text" name="first_name" id="first_name" required placeholder='first name'/>
                    </div>
                    <div className="flex flex-col mb-4">
                        ...
                        <input className="border py-2 px-3 text-grey-800 outline-blue-400" type="text" name="last_name" id="last_name" required placeholder='last name'/>
                    </div>
                    <div className="flex flex-col mb-4 relative">
                        ...
                        <input className="border py-2 px-3 text-grey-800 outline-blue-400" type="email" name="email" id="email" required placeholder='email adress'/>
                    </div>
                    <div className="flex flex-col mb-4 relative">
                        ...
                        <input className="border py-2 px-3 text-grey-800 outline-blue-400" type="password" name="password" id="password" required placeholder='password'/>
                    </div>
                    <div>
                    ...
                    <button className="transition duration-500 w-full bg-blue-400 hover:bg-blue-600 text-white uppercase text-lg mx-auto p-3 rounded" type="submit">Create Account</button>
                </form>
